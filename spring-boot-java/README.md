# iCL 2.0 External Server Sample (Spring Boot / java)
...
## HOW TO RUN (docker)
```bash
docker build . -t icl2-external-server-sample-java

docker run -p 8080:8080 -d icl2-external-server-sample-java
```
